...
srvd_boolean_t srvd_service_nss_passwd_request_uid_get(const srvd_service_request_t *request,
  ...
  return srvd_protocol_packet_field_get_uint32(field, (uint32_t *)uid);
}
...
srvd_boolean_t srvd_service_nss_passwd_response_name_set(srvd_service_response_t *response,
  ...
  return srvd_protocol_packet_field_add(&response->packet, SRVD_SERVICE_NSS_PASSWD_RESPONSE_NAME,
                                        length, name);
}
...
srvd_boolean_t srvd_service_nss_passwd_response_uid_set(srvd_service_response_t *response,
  ...
  return srvd_protocol_packet_field_add_uint32(&response->packet,
                                               SRVD_SERVICE_NSS_PASSWD_RESPONSE_UID, (uint32_t)uid);
}
...
srvd_boolean_t srvd_service_nss_passwd_response_gid_set(srvd_service_response_t *response,
  ...
  return srvd_protocol_packet_field_add_uint32(&response->packet,
                                               SRVD_SERVICE_NSS_PASSWD_RESPONSE_GID, (uint32_t)gid);
}
...
srvd_boolean_t srvd_service_nss_passwd_response_dir_set(srvd_service_response_t *response,
  ...
  return srvd_protocol_packet_field_add(&response->packet, SRVD_SERVICE_NSS_PASSWD_RESPONSE_DIR,
                                        length, dir);
}
...
srvd_boolean_t srvd_service_nss_passwd_response_shell_set(srvd_service_response_t *response,
  ...
  return srvd_protocol_packet_field_add(&response->packet, SRVD_SERVICE_NSS_PASSWD_RESPONSE_SHELL,
                                        length, shell);
}
...
srvd_boolean_t srvd_service_nss_passwd_response_gecos_set(srvd_service_response_t *response,
  ...
  return srvd_protocol_packet_field_add(&response->packet, SRVD_SERVICE_NSS_PASSWD_RESPONSE_GECOS,
                                        length, gecos);
}
